...
| Urban Mobility | [GtfsTransitFeedFile](https://gitlab.com/synchronicity-iot/synchronicity-data-models/blob/master/UrbanMobility/GTFSTransitFeedFile/doc/spec.md) | Provides the Location (URL) of the ZIP file containing a valid GTFS transit feed.
