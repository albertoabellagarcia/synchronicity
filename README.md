...
| PointOfInterest | [Store](./PointOfInterest/Store/doc/spec.md) | A harmonised geographic description of a store | Developed by SynchroniCity | Under discussion |
...
| Transportation | [CarSharingStation](./Transportation/CarSharingStation/doc/spec.md) | A site dedicated to car sharing with either direct access from a road or with suitable and clearly marked access points. | Developed by SynchroniCity | Under discussion |
| Transportation | [RestrictedTrafficArea](./Transportation/RestrictedTrafficArea/doc/spec.md) |An area of a city in which the traffic generated by cars or any other kind of vehicles is subjected to limitation. | Developed by SynchroniCity | Under discussion |
