...
+ [CarSharingStation](../CarSharingStation/doc/spec.md). It represents a site dedicated to car sharing with either direct access from a road or with suitable and clearly marked access points.
+ [RestrictedTrafficArea](../RestrictedTrafficArea/doc/spec.md). It represents an area of a city in which the traffic generated by cars or any other kind of vehicles is subjected to limitation.
+ [RestrictionException](../RestrictedTrafficArea/RestrictionException/doc/spec.md). It represents a particular expection of restriction reported in a “Restricted Traffic Areas”.
+ [SpecialRestriction](../RestrictedTrafficArea/SpecialRestriction/doc/spec.md). It represents a particular case that specialise restriction reported in a “Restricted Traffic Areas”.